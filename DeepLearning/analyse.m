function analysis = analyse()
    ...
    model = loadLearnerForCoder('C:\Users\FouKoMD\Desktop\Genre-Recognition-main\DeepLearning\frem.mat'); % read model
    ...
    %save the genre in a variable (res)
    res = cellstr(TestVotes);
